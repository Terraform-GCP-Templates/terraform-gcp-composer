module "simple-composer-environment" {
  ...
  service_account      = module.project_level_iam.service_account_email
...
resource "null_resource" "upload_composer_dag" {
  ...
  provisioner "local-exec" {
    ...
    command = "gsutil -m rsync -d -r ${var.folder_path} ${module.simple-composer-environment.gcs_bucket}/"
